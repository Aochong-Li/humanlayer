...
- Version numbering
- Protocols for the core components of humanlayer.
...
global_config_dir = Path(os.getenv("HL_GLOBAL_CONFIG_DIR") or user_config_dir("humanlayer"))
global_config_dir.mkdir(parents=True, exist_ok=True)
global_config_file = Path(global_config_dir) / ".env"

if not os.getenv("MSWEA_SILENT_STARTUP"):
    Console().print(
        f"👋 This is [bold green]humanlayer[/bold green] version [bold green]{__version__}[/bold green].\n"
