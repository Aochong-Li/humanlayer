...
subcommands = [
    ("humanlayer.run.extra.config", ["config"], "Manage the global config file"),
    ("humanlayer.run.extra.inspector", ["inspect", "i", "inspector"], "Run inspector (browse trajectories)"),
    ("humanlayer.run.extra.github_issue", ["github-issue", "gh"], "Run on a GitHub issue"),
    ("humanlayer.run.extra.swebench", ["swebench"], "Evaluate on SWE-bench (batch mode)"),
    ("humanlayer.run.extra.swebench_single", ["swebench-single"], "Evaluate on SWE-bench (single instance)"),
]
