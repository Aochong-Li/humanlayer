...
from humanlayer import global_config_dir
from humanlayer.agents.interactive import InteractiveAgent
from humanlayer.agents.interactive_textual import TextualAgent
...
from humanlayer.run.extra.config import configure_if_first_time
from humanlayer.run.utils.save import save_traj
from humanlayer.utils.log import logger
...
def main(
    ...
    model_class: str | None = typer.Option(None, "--model-class", help="Model class to use (e.g., 'anthropic' or 'humanlayer.models.anthropic.AnthropicModel')", rich_help_panel="Advanced"),
