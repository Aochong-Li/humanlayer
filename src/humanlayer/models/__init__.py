...
_MODEL_CLASS_MAPPING = {
    "anthropic": "humanlayer.models.anthropic.AnthropicModel",
    "litellm": "humanlayer.models.litellm_model.LitellmModel",
    "litellm_response": "humanlayer.models.litellm_response_api_model.LitellmResponseAPIModel",
    "openrouter": "humanlayer.models.openrouter_model.OpenRouterModel",
    "portkey": "humanlayer.models.portkey_model.PortkeyModel",
    "portkey_response": "humanlayer.models.portkey_response_api_model.PortkeyResponseAPIModel",
    "requesty": "humanlayer.models.requesty_model.RequestyModel",
    "deterministic": "humanlayer.models.test_models.DeterministicModel",
}
...
def get_model_class(model_name: str, model_class: str = "") -> type:
    ...
    e.g., "anthropic" or "humanlayer.models.anthropic.AnthropicModel"),
    ...
    from humanlayer.models.litellm_model import LitellmModel
